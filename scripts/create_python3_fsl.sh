...
TEMP_DIRECTORY=$PROJECT_DIRECTORY/temp/$LAYER_NAME
TARGET_FSL=$PROJECT_DIRECTORY/file_system_layers/$LAYER_NAME
TARGET_CONTAINER=$PROJECT_DIRECTORY/containers/$LAYER_NAME
